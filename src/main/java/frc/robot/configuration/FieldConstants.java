...
public final class FieldConstants {
    ...
    public static final double kRobotWidth = 1.435;
    ...
    public static final Pose2d kBlueClimbEngageLeftFront = new Pose2d(1.127 + kRobotWidth / 2, 3.315, Rotation2d.fromDegrees(0));
    public static final Pose2d kBlueClimbEngageRightFront = new Pose2d(1.127 + kRobotWidth / 2, 4.172, Rotation2d.fromDegrees(0));
    public static final Pose2d kBlueClimbStageLeftFront = new Pose2d(1.127 + 2 * kRobotWidth, 3.315, Rotation2d.fromDegrees(0));
    public static final Pose2d kBlueClimbStageRightFront = new Pose2d(1.127 + 2 * kRobotWidth, 4.172, Rotation2d.fromDegrees(0));
