...
public final class FieldConstants {
    ...
    public static final Pose2d kBlueClimbStageRightSide = new Pose2d(2, 2.000, Rotation2d.fromDegrees(63));
    public static final Pose2d kBlueClimbEngageRightSide = new Pose2d(1.065, 2.814, Rotation2d.fromDegrees(90));
    public static final Pose2d kBlueClimbStageLeftSide = new Pose2d(2, 5.501, Rotation2d.fromDegrees(297));
