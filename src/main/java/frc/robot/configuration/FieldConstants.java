...
public final class FieldConstants {
    ...
    public static final Pose2d kBlueClimbStageRightSide = new Pose2d(1.5, 2.3, Rotation2d.fromDegrees(90));
    public static final Pose2d kBlueClimbEngageRightSide = new Pose2d(1.1, 2.8, Rotation2d.fromDegrees(90));
    public static final Pose2d kBlueClimbStageLeftSide = new Pose2d(1.5, 5, Rotation2d.fromDegrees(270));
    public static final Pose2d kBlueClimbEngageLeftSide = new Pose2d(1.1, 4.5, Rotation2d.fromDegrees(270));
